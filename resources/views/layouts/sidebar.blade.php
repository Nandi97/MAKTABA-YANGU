<aside class="pt-1 sticky flex flex-col border-r border-base-200
text-neutral-content shadow-lg bg-neutral rounded-box h-full top-0 p-2 m-0 z-40">
<div>
    <div class="sticky navbar inset-x-0 top-0 z-50 hidden w-full py-1 transition
        duration-200 ease-in-out border-b lg:block border-base-200 bg-neutral rounded-t-lg">
                    ...
                    <a href="/books" class="capitalize">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                5.477 9.246
                                5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477
                                5.754 18 7.5
                                18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754
                                5 16.5
                                5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477
                                18.247 18
                                16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                            </svg>
                            Books
                        ...
                        <a href="/users" class="capitalize">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path stroke-linecap="round"
                                    stroke-linejoin="round"
                                    stroke-width="2" d="M5.121 17.804A13.937
                                    13.937 0
                                    0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3
                                    3 0 11-6
                                    0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118
                                    0z" />
                                </svg>
                                Users
                            </a>
                        ...
                        <li class="hover:bg-green-500">
                            <a class="nav-link" href="#" class="pt-5 capitalize">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    stroke-current" fill="none" viewBox="0 0 24
                                    24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round"
                                        stroke-linejoin="round"
                                        stroke-width="2" d="M9 17v-2m3 2v-4m3
                                        4v-6m2
                                        10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1
                                        1 0
